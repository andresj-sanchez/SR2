...
Examples:
  python tools/dwarf-compare.py -u Develop/Projects/SR2/pgm/src/Object/Player/Performance.cpp -f "clsPrfm::setup"
  python tools/dwarf-compare.py -u Develop/Projects/SR2/pgm/src/Object/Player/Performance.cpp -f "clsPrfm::setMaxAgp(float)" --summary
  python tools/dwarf-compare.py -u Develop/Projects/SR2/pgm/src/Object/Player/Performance.cpp -f "clsPrfm::setup" --full-diff
  python tools/dwarf-compare.py -u Develop/Projects/SR2/pgm/src/Object/Player/Performance.cpp -f "clsPrfm::setup" --require-exact
"""
...
def dtk_dwarf_dump(obj_path: str) -> str:
    ...
    fd, output_path = tempfile.mkstemp(prefix="sr2_dwarf_compare_", suffix=".nothpp")
    os.close(fd)
...
def canonical_debug_path(debug_path: str) -> str:
    ...
    if "/develop/projects/sr2/" in lowered:
        sr2_index = lowered.index("/develop/projects/sr2/")
        suffix = normalized[sr2_index + len("/develop/projects/sr2/") :].lstrip("/")
        return os.path.normpath("src/Develop/Projects/SR2/" + suffix.lstrip("/")).replace("\\", "/")
...
def debug_lines_cache_dir() -> str:
    cache_dir = os.path.join(tempfile.gettempdir(), "sr2_dwarf_compare")
...
def build_debug_lines_file_for_object(obj_path: str) -> str:
    temp_dir = tempfile.mkdtemp(prefix="sr2_debug_lines_")
